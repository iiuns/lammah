...
def get_style(age):
    if age < 15:
        ...
        return "مفصلة وعميقة ووقورة , استخدم لغه مهذبه ولا تستخدم القاب مثل يابني او ياولدي، 6-7 جمل"
...
تكلم باللهجة النجدية العامية الواضحة بشكل طبيعي وودي ولا تتكلم بغيرها ابدا.
خاطب الاطفال باسلوب لطيف
خاطب كبار السن بتقدير وبلا تكلف
أسلوب إجابتك: {style}."""
            },
